...
const Header = () => {
  const orderCount = useSelector((state:{orderList:ProductType[]}) => state.orderList)
  return (
    <div className='w-full flex justify-between items-center py-5'>
      ...
      <ButtonUi extraClass='bg-[#FE5F1E] rounded-[30px] w-[150px] h-[50px] text-white hover:bg-[#FE5F1E]'>
          ...
          <strong className='text-[16px] font-bold flex items-center gap-1'><Cart/>{orderCount.length}</strong>
      </ButtonUi>
    </div>
  )
}
